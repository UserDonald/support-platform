...
import { getCountryFlagUrl, getCountryFromTimzeone } from '@/lib/country-utils';
        ...
        <ScrollArea className="max-h-[calc(100vh-53px)]">
          <div className="flex w-full flex-1 flex-col text-sm">
            {conversations.results.map((conversation, index) => {
              ...
              const country = getCountryFromTimzeone(
...
export const SkeletonConversations = () => {
  return (
    <div className="flex min-h-0 flex-1 flex-col gap overflow-auto">
